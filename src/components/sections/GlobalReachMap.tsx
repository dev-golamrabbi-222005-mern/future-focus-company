...
import { Globe, MapPin, Quote, Building, CheckCircle2 } from 'lucide-react';
...
export function GlobalReachMap() {
  ...
  const hubs = [
    { name: t('saudiLabel'), count: t('saudiCount'), flag: '🇸🇦' },
    { name: t('uaeLabel'), count: t('uaeCount'), flag: '🇦🇪' },
    { name: t('qatarLabel'), count: t('qatarCount'), flag: '🇶🇦' },
    { name: t('kuwaitLabel'), count: t('kuwaitCount'), flag: '🇰🇼 / 🇴🇲' },
  ];
                ...
                <div className="flex items-center gap-3.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground font-semibold flex items-center gap-1 mt-0.5">
                      <CheckCircle2 className="h-3.5 w-3.5 text-emerald-500" /> Active Placement Corridor
                    </p>
                  </div>
                </div>
