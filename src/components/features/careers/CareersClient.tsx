  ...
  return (
    <div className="w-full overflow-hidden">
      ...
      <section className="relative flex items-center justify-center overflow-hidden w-full h-auto lg:max-h-[750px] pt-8 md:pt-10 lg:pt-12 pb-12 md:pb-16 lg:pb-20">
        ...
        <div className="relative z-10 mx-auto max-w-[1380px] px-4 md:px-6 lg:px-8 text-center w-full">
          <motion.div
          ...
          <motion.div
            ...
            className="mt-8 md:mt-12 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-5xl mx-auto"
          >
            {heroStats.map((s, i) => {
              const Icon = s.icon;
              return (
