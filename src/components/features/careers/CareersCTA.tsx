...
export default function CareersCTA() {
  ...
  useGSAP(
    () => {
      ...
      gsap.fromTo(
        ref.current.querySelectorAll(".cta-up"),
        { opacity: 0, y: 45 },
        {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[1380px] px-4 md:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[2.5rem] border border-primary/20 bg-gradient-to-br from-primary/8 via-card to-sky-400/8 shadow-2xl">
          {/* Inner glow */}
          ...
          <div className="relative px-6 py-14 sm:px-10 sm:py-16 md:px-14 lg:px-20 text-center space-y-8">
            ...
            {/* Divider */}
            <div className="cta-up mx-auto h-[3px] w-20 rounded-full bg-gradient-to-r from-primary to-cyan-400" />

            {/* Description */}
            <p className="cta-up mx-auto max-w-2xl text-base md:text-lg leading-8 text-muted-foreground">
              {t("ctaDesc")}
            </p>

            {/* Benefits grid */}
            <div className="cta-up grid grid-cols-2 sm:grid-cols-4 gap-3 max-w-2xl mx-auto">
            ...
            {/* Buttons */}
            <div className="cta-up flex flex-col sm:flex-row items-center justify-center gap-4">
