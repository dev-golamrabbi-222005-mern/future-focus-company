...
export function ProcessTimeline() {
  ...
  useGSAP(
    () => {
      ...
      // Scroll-triggered progress line fill animation
      gsap.fromTo(
      ...
      // Reveal step cards sequentially
      const stepItems = containerRef.current.querySelectorAll('.step-card');
      gsap.fromTo(
        stepItems,
        { opacity: 0, x: -30 },
        {
        ...
        <div className="space-y-10">
          {steps.map((step) => {
            ...
            return (
              ...
              >
                {/* Step Icon Badge anchored to the vertical line */}
                ...
                {/* Step Content Card */}
                <div className="flex-1 bg-card border border-border/80 rounded-2xl p-6 shadow-sm hover:shadow-lg transition-all duration-300">
